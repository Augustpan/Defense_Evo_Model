...
// an implementation of the functionality of `numpy.linspace(...)` in Python package numpy
...
// an implementation of the functionality `numpy.argmax(...)` in Python package numpy
...
// parameter k of our model is set fixed at k = 1, so there's no k in the following code.
